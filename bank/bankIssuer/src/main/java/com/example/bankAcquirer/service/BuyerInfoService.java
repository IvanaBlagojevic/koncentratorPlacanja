...
public class BuyerInfoService {
	...
	/*
	public BuyerInfo addNewBuyerInfo(BuyerInfo user) 
	{
		
		/return buyerInfoRepository.save(user);
	}*/
	...
	public InterbankResponseDTO requestToPCC(Transaction request,BuyerInfo buyerInfo) {
		// TODO Auto-generated method stub
	...
	public IssuerResponseDTO requestToPCC(Transaction transaction, InterbankRequestDTO dto) {
		// TODO Auto-generated method stub
		IssuerResponseDTO irDTO = new IssuerResponseDTO();
		irDTO.setAccount(transaction.getAccountPayer());
		irDTO.setAcquirerOrderId(dto.getAcquirerOrderId());
		irDTO.setAcquirerTimestamp(dto.getAcquirerTimestamp());
		irDTO.setIssuerOrderId(transaction.getId().toString());
		irDTO.setIssuerTimestamp(transaction.getTimestamp());
		irDTO.setTransactionStatus(transaction.getStatus());
