...
public class AuthServiceApplication {
	...
	public static void main(String[] args) {
		...
		System.setProperty("KEY_STORE_CLASSPATH_TRUST", "src/main/resources/authTrusted.jks");
		System.setProperty("KEY_STORE_PASSWORD", "password");
		System.setProperty("KEY_STORE_TRUST_PASSWORD", "password");
		System.setProperty("KEY_STORE_ALIAS", "auth");
	...
	public DiscoveryClient.DiscoveryClientOptionalArgs discoveryClientOptionalArgs() throws NoSuchAlgorithmException {
		...
		System.setProperty("javax.net.ssl.trustStore", "src/main/resources/authTrusted.jks");
